...
function AdminQuestions() {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await fetch(
        "https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/questions",
        {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingId
        ? `https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/questions/${editingId}`
        : "https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/questions";
  ...
  const handleDelete = async (questionId) => {
    ...
    try {
      await fetch(`https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/questions/${questionId}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
