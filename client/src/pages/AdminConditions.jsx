...
function AdminConditions() {
  ...
  const fetchConditions = async () => {
    try {
      const response = await fetch(
        "https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/conditions",
        {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingId
        ? `https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/conditions/${editingId}`
        : "https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/conditions";
  ...
  const handleDelete = async (conditionId) => {
    ...
    try {
      await fetch(`https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/conditions/${conditionId}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
      setConditions((prev) =>
