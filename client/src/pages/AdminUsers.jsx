...
function AdminUsers() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch("https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/users", {
  ...
  const toggleRole = async (userItem) => {
    ...
    try {
      const response = await fetch(
        `https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/users/${userItem._id}/role`,
        {
          method: "PUT",
          headers: {
  ...
  const handleDelete = async (userItem) => {
    ...
    try {
      const response = await fetch(
        `https://projet-de-fin-de-formation-0opo.onrender.com/api/admin/users/${userItem._id}`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        },
